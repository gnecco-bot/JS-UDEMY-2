...
function criaAplicadorDeDesconto(valorDesconto) {
...
const aplicarDesconto20 = criaAplicadorDeDesconto(0.20);
const aplicarDesconto10 = criaAplicadorDeDesconto(0.10);
