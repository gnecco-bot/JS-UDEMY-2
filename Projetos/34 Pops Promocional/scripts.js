...
botaoAlerta.onclick = function () {
    alert('Está é uma mensagem de alerta')
}

var botaoNotificacao = document.getElementById('botaoNotificacao');
botaoNotificacao.onclick = function () {
    var notificao = document.getElementById('notificacao');
    notificao.className = "notificacao mostrar";
    setTimeout(() => {
        notificao.className = notificao.className.replace('mostrar', '');
    }, 3000);
}
...
botaoEnviar.onclick = function () {
    ...
    entradaTexto.atyle.display = 'none';
}
