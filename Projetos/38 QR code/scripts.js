document.getElementById('selecionarArquivo').addEventListener('change', function (evento) {
    ...
    leitor.onload = function (evento) {
        ...
        img.onload = function () {
            ...
            if (codigo) {
                document.getElementById('resultado').innerHTML = `Código QR lido: ${codigo.data}`;
            } else {
                document.getElementById('resultado').innerHTML = `Não foi possivel ler o QR Code. Tente novamente.`;
            }
        };
